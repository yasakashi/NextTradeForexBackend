...
namespace NextTradeAPIs.Controllers
{
    ...
    public class ADPodcastController : ControllerBase
    {
        ...
        ADPodcastServices _thisService;

        public ADPodcastController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       IWebHostEnvironment env,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       CategoriesServices userTypeServices,
                                       ADPodcastServices courseBuilderServices,
        ...
        [HttpPost]
        [Route("/api/adminpanel/tools/addnewpodcast")]
        [AllowAnonymous]
        public async Task<IActionResult> InsertPodcast([FromForm] ADPodcastDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddNewADPodcast(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/adminpanel/tools/deletepodcast")]
        [AllowAnonymous]
        public async Task<IActionResult> DeletePodcast(ADPodcastSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.RemoveADPodcast(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/adminpanel/tools/getpodcasts")]
        [AllowAnonymous]
        public async Task<IActionResult> GetPodcasts(ADPodcastSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetADPodcasts(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/adminpanel/tools/editpodcast")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdatePodcast([FromForm] ADPodcastDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.EditADPodcast(model, userlogin, processId, clientip, hosturl);
