...
namespace NextTradeAPIs.Controllers
{
    ...
    public class TicktingController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/ticket/gettickets")]
        public async Task<IActionResult> GetTickets(TicketDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [Route("/api/ticket/getmytickets")]
        public async Task<IActionResult> GetMyTickets(TicketDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                model.creatoruserId = userlogin.userid;
