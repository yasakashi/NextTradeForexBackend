...
namespace NextTradeAPIs.Controllers
{
    ...
    public class CommunityGroupControllerController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/getcommunitygroups")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCommunityGroup(GroupSearchFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _communityGroupService.GetCommunityGroup(model, null, processId, clientip, hosturl);
