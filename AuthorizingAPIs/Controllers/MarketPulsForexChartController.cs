...
namespace NextTradeAPIs.Controllers
{
    ...
    public class MarketPulsForexChartController : ControllerBase
    {
        ...
        MarketPulsForexChartServices _service;
        CategoriesServices _baseInformationService;
        ForumsServices _forumsService;

        public MarketPulsForexChartController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       MarketPulsForexChartServices marketPulsforexchartServices,
        ...
        UserServices userServices)
        {
            ...
            _service = marketPulsforexchartServices;
        ...
        [HttpPost]
        [Route("/api/marketpuls/addforexchartitem")]
        [AllowAnonymous]
        public async Task<IActionResult> CreateForexChartItem(ForexChartDto model)
        {
            ...
            try
            {
                ...
                message = await _service.SaveForexChartItem(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/marketpuls/editforexchartitem")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateForexChartItem(ForexChartDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _service.UpdateForexChartItem(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetForexChartItems(ForexChartFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _service.GetForexChartItems(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> DeleteForexChartItems(ForexChartFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _service.DeleteForexChartItem(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetCategories(ForexChartFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetCategory4MarketPulsForexChart(model, null, processId, clientip, hosturl, false);
        ...
        public async Task<IActionResult> GetforexchartCurrencies(ForexChartFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetCategoryCurrency4MarketPulsForexChart(model, null, processId, clientip, hosturl, false);
