...
namespace NextTradeAPIs.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        #region coursemeets
        [HttpPost]
        [Route("/api/editcoursemeet")]
        [AllowAnonymous]
        public async Task<IActionResult> EditCourseMeet(CourseMeetDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.EditCourseMeet(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/addcoursemeet")]
        [AllowAnonymous]
        public async Task<IActionResult> AddCourseMeet(CourseMeetDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.AddCourseMeet(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/getcoursemeet")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCourseMeets(CourseMeetDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.GetCourseMeets(model, null, processId, clientip, hosturl);
        ...
        #region coursepdfs
        [HttpPost]
        [Route("/api/editcoursepdf")]
        [AllowAnonymous]
        public async Task<IActionResult> EditCoursePDF(CoursePDFDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.EditCoursePDF(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/addcoursepdf")]
        [AllowAnonymous]
        public async Task<IActionResult> AddCoursePDF(CoursePDFDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.AddCoursePDF(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/getcoursepdf")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCoursePDFs(CoursePDFDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.GetCoursePDFs(model, null, processId, clientip, hosturl);
        ...
        #region coursevideos
        [HttpPost]
        [Route("/api/editcoursevideo")]
        [AllowAnonymous]
        public async Task<IActionResult> EditCourseVideo(CourseVideoDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.EditCourseVideo(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/addcoursevideo")]
        [AllowAnonymous]
        public async Task<IActionResult> AddCourseVideo(CourseVideoDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.AddCourseVideo(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/getcoursevideo")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCourseVideos(CourseVideoDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.GetCourseVideos(model, null, processId, clientip, hosturl);
        ...
        #region courseTopics
        [HttpPost]
        [Route("/api/editcoursetopic")]
        [AllowAnonymous]
        public async Task<IActionResult> EditCourseTopic(CourseTopicDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.EditCourseTopic(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/addcoursetopic")]
        [AllowAnonymous]
        public async Task<IActionResult> AddCourseTopic(CourseTopicDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.AddCourseTopic(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/getcoursetopic")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCourseTopics(CourseTopicDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _courseService.GetCourseTopics(model, null, processId, clientip, hosturl);
