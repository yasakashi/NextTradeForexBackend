...
namespace NextTradeAPIs.Controllers
{
    ...
    public class AdminPanelController : ControllerBase
    {
        ...
        BaseReportServices _Service;

        public AdminPanelController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       BaseReportServices ticketServices,
                                       ...
                                       UserServices userServices)
        {
            ...
            _Service = ticketServices;
        }

        [HttpPost]
        [HttpGet]
        [Route("/api/adminpanel/adminData")]
        [AllowAnonymous]
        public async Task<IActionResult> AdminPanelReport()
        {
            ...
            try
            {
                ...
                message = await _Service.GetBasePageAdminPanelReport(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/adminpanel/users/getalltotalusers")]
        [AllowAnonymous]
        public async Task<IActionResult> GetTotalUserReport()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _Service.GetTotalUserReport(null, processId, clientip, hosturl);
