...
namespace NextTradeAPIs.Controllers
{
    ...
    public class ForumsController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/gettoplastestforummessage")]
        [AllowAnonymous]
        public async Task<IActionResult> GetTopLatestForumMessage(ForumMessageFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _forumsService.GetTopLatestForumMessage(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/editforummessage")]
        [AllowAnonymous]
        public async Task<IActionResult> EditForumMessage(ForumMessageFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _forumsService.EditForumMessage(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/deleteforummessage")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteForumMessage(ForumMessageFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _forumsService.DeleteForumMessage(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> AddForumMessagePic([FromForm] CommunityGroupImageDto model)
        {
            ...
            try
            {
                ...
                if (model.photofile != null)
                {
                    ...
                    modeldate.photofilecontenttype = model.photofile.ContentType;
                    using (var ms = new MemoryStream())
                    {
                        model.photofile.CopyTo(ms);
                        message = await _forumsService.SaveFile(ms.ToArray(), userlogin.userid, model.Id.ToString().Replace("-", ""), model.photofile.FileName, sitePath);
                        if(message.MessageCode > 0)
                        modeldate.photofileurl = message.MessageData.ToString();
                    }
                }
                    ...
                    if (model.audiofile != null)
                    {
                        ...
                        modeldate.audiofilecontenttype = model.audiofile.ContentType;
                        using (var ms = new MemoryStream())
                        {
                            model.audiofile.CopyTo(ms);
                            message = await _forumsService.SaveFile(ms.ToArray(), userlogin.userid, model.Id.ToString().Replace("-", ""), model.audiofile.FileName, sitePath);
                        if (message.MessageCode > 0)
                            modeldate.audiofileurl = message.MessageData.ToString();
                        }
                    }
                    if (model.videofile != null)
                    {
                        ...
                        modeldate.videofilecontenttype = model.videofile.ContentType;
                        using (var ms = new MemoryStream())
                        {
                            model.videofile.CopyTo(ms);
                            message = await _forumsService.SaveFile(ms.ToArray(), userlogin.userid, model.Id.ToString().Replace("-", ""), model.videofile.FileName, sitePath);
                        if (message.MessageCode > 0)
                            modeldate.videofileurl = message.MessageData.ToString();
                        }
        ...
        {
            SystemMessageModel message = await _forumsService.GetForumMessageImage(id);
        ...
        [HttpPost]
        [Route("/api/createforummessagereaction")]
        [AllowAnonymous]
        public async Task<IActionResult> SaveForumMessageReaction(ForumMessageReactionDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _forumsService.CreateForumMessageReaction(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/getforummessagereaction")]
        [AllowAnonymous]
        public async Task<IActionResult> GetForumMessageReaction(ForumMessageReactionDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _forumsService.GetForumMessageReaction(model, userlogin, processId, clientip, hosturl);
