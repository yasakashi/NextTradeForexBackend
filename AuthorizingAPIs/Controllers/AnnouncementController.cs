...
namespace NextTradeAPIs.Controllers
{
    ...
    public class AnnouncementController : ControllerBase
    {
        ...
        AnnouncementServices _thisService;

        public AnnouncementController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       IWebHostEnvironment env,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       CategoriesServices userTypeServices,
                                       AnnouncementServices courseBuilderServices,
        ...
        [HttpPost]
        [Route("/api/adminpanel/addnewannouncement")]
        [AllowAnonymous]
        public async Task<IActionResult> InsertAnnouncement( AnnouncementDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddNewAnnouncement(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/adminpanel/deleteannouncement")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteAnnouncement(AnnouncementDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.RemoveAnnouncement(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/adminpanel/getannouncements")]
        [AllowAnonymous]
        public async Task<IActionResult> GetAnnouncements(AnnouncementSearchFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetAnnouncements(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/adminpanel/editannouncement")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateAnnouncement( AnnouncementDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.EditAnnouncement(model, userlogin, processId, clientip, hosturl);
