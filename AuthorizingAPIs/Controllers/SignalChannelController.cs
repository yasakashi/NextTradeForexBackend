    ...
    public class SignalChannelController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetSignalChannel(SignalChannelDto model)
        {
            ...
            try
            {
                ...
                message = await _signalChannelService.GetSignalChannel(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> AddSignalChannel(SignalChannelDto model)
        {
            ...
            try
            {
                ...
                message = await _signalChannelService.CreateSignalChannel(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> RemoveSignalChannel(SignalChannelDto model)
        {
            ...
            try
            {
                ...
                message = await _signalChannelService.RemoveSignalChannel(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> EditSignalChannel(SignalChannelDto model)
        {
            ...
            try
            {
                ...
                message = await _signalChannelService.EditSignalChannel(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/signal/addsignal")]
        [AllowAnonymous]
        public async Task<IActionResult> AddSignal(SignalDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _signalChannelService.CreateSignal(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/signal/deletesignal")]
        [AllowAnonymous]
        public async Task<IActionResult> RemoveSignal(SignalDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _signalChannelService.DeleteSignal(model, userlogin, processId, clientip, hosturl);
        ...
        [Route("/api/signal/uploadsignalimage")]
        [HttpPost]
        public async Task<IActionResult> CreateSignalPic([FromForm] CommunityGroupImageDto model)
        {
            ...
            try
            {
                ...
                if (model.coverPicture != null)
                {
                    ...
                    SignalFileAttachmentDto modeldate = new SignalFileAttachmentDto()
                    {
                        Id = model.Id,
                    };
        ...
        [HttpPost]
        [Route("/api/signal/getsignal")]
        [AllowAnonymous]
        public async Task<IActionResult> GetSignal(SignalDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _signalChannelService.GetSignals(model, userlogin, processId, clientip, hosturl);
