...
namespace NextTradeAPIs.Controllers
{
    ...
    public class MarketPulsForexController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/marketpuls/editforexitem")]
        [AllowAnonymous]
        public async Task<IActionResult> EditForexItem(ForexDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _service.UpdateForexItem(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetForexItems(ForexFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _service.GetForexItem(model, null, processId, clientip, hosturl);
