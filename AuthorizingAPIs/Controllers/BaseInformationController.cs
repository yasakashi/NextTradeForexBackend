    ...
    public class BaseInformationController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCategory()
        {
            ...
            try
            {
               var _bearer_token = Request.Headers[HeaderNames.Authorization].ToString().Replace("Bearer ", "");
                ...
                message = await _userTypeService.GetCategory(userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetAnalysisTypes()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetAnalysisTypes(userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetPositionTypes()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetPositionTypes(userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetMarketCycles()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetMarketCycles(userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetInstruments()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetInstruments(userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetEntryPoints()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetEntryPoints(userlogin, processId, clientip, hosturl);
