...
namespace NextTradeAPIs.Controllers
{
    ...
    public class BaseInformationController : ControllerBase
    {
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetCategory(CategoryFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _categoriesServices.GetCategory(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getleantotradetopcategories")]
        [AllowAnonymous]
        public async Task<IActionResult> GetLean2TradeTopCategories()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                CategorisDto filter = new CategorisDto() { parentId = 770 };

                message = await _categoriesServices.GetCategoryFullInfo(filter, null, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetTopicTypes()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetTopicTypes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/gettopicstatuses")]
        [AllowAnonymous]
        public async Task<IActionResult> GetTopicStatuses()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetTopicStatuss(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getpdfpagerendersizes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetPDFPageRenderSizes()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetPDFPageRenderSizes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/gethardpages")]
        [AllowAnonymous]
        public async Task<IActionResult> GetHardPages()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetHardPages(null, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetDisplayModes()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetDisplayModes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getbooksourcetypes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetBookSourceTypes()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetBookSourceTypes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getautoenablesounds")]
        [AllowAnonymous]
        public async Task<IActionResult> GetAutoEnableSounds()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetAutoEnableSounds(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getenabledownloads")]
        [AllowAnonymous]
        public async Task<IActionResult> GetEnableDownloads()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetEnableDownloads(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getpagemodes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetPageModes()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetPageModes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getsinglepagemodes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetSinglePageModes()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetSinglePageModes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getcontrolspositions")]
        [AllowAnonymous]
        public async Task<IActionResult> GetControlsPositions()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetControlsPositions(null, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetDirections()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetDirections(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getenableautoplayes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetEnableAutoplays()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetEnableAutoplays(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getenableautoplayautomaticallies")]
        [AllowAnonymous]
        public async Task<IActionResult> GetEnableAutoplayAutomaticallies()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetEnableAutoplayAutomaticallys(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getpagesizes")]
        [AllowAnonymous]
        public async Task<IActionResult> GetPageSizes()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetPageSizes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getforumformats")]
        [AllowAnonymous]
        public async Task<IActionResult> GetForumFormats()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetForumFormats(null, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetFileTypes()
        {
            ...
            try
            {
                ...
                message = await _baseInformationService.GetFileTypes(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getsystemparts")]
        [AllowAnonymous]
        public async Task<IActionResult> GetSystemParts()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetSystemParts(null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/getforumroles")]
        [AllowAnonymous]
        public async Task<IActionResult> GetForumRoles()
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetForumRoles(null, processId, clientip, hosturl);
