...
namespace NextTradeAPIs.Controllers
{
    ...
    {
        private SiteMessageServices _siteMessageService;
                                       ...
                                       UserServices userServices)
        {
            ...
            _siteMessageService = siteMessageServices;
        }



        [HttpPost]
        [Route("/api/sitemessage/getmessage")]
        [AllowAnonymous]
        public async Task<IActionResult> GetSiteMessage(SiteMessageDto model)
        {
            ...
            try
            {
                ...
                message = await _siteMessageService.GetSiteMessage(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/sitemessage/getmessagenotvisitedcount")]
        [AllowAnonymous]
        public async Task<IActionResult> GetSiteMessageNotVisitedCount(SiteMessageDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _siteMessageService.GetUserSiteMessageCount(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/sitemessage/addmessage")]
        [AllowAnonymous]
        public async Task<IActionResult> AddSiteMessage(SiteMessageDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _siteMessageService.CreateSiteMessage(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/sitemessage/visitmessage")]
        [AllowAnonymous]
        public async Task<IActionResult> VisitSiteMessage(SiteMessageDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _siteMessageService.VisitSiteMessage(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/sitemessage/deletemessage")]
        [AllowAnonymous]
        public async Task<IActionResult> RemoveSiteMessage(SiteMessageDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _siteMessageService.RemoveSiteMessage(model, userlogin, processId, clientip, hosturl);
