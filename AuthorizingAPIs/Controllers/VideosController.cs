...
namespace NextTradeAPIs.Controllers
{
    ...
    public class VideoController : ControllerBase
    {
        ...
        LearnToTradeVideoServices _thisService;

        public VideoController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       IWebHostEnvironment env,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       CategoriesServices userTypeServices,
                                       LearnToTradeVideoServices courseBuilderServices,
        ...
        [HttpPost]
        [Route("/api/learntotrade/addnewVideo")]
        [AllowAnonymous]
        public async Task<IActionResult> InsertVideo([FromForm] VideoDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddNewLearnToTradeVideo(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/learntotrade/deleteVideo")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteVideo(VideoSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.RemoveLearnToTradeVideo(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/learntotrade/getVideos")]
        [AllowAnonymous]
        public async Task<IActionResult> GetVideos(VideoSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetLearnToTradeVideos(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/learntotrade/editVideo")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateVideo([FromForm] VideoDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.EditLearnToTradeVideo(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/learntotrade/addnewVideosubtitle")]
        [AllowAnonymous]
        public async Task<IActionResult> InsertVideoSubtitle([FromForm] VideoSubtitleDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                if (model.subtitlefile != null)
                {
                    ...
                    if (model.subtitlefile.FileName == null || model.subtitlefile.FileName.Length == 0)
                    {
                        // return Content("File not selected");
                    }
                    ...
                    using (var ms = new MemoryStream())
                    {
                        model.subtitlefilecontenttype = model.subtitlefile.ContentType;
                        model.subtitlefilename = model.subtitlefile.FileName;

                        model.subtitlefile.CopyTo(ms);
                        message = await _thisService.SaveSubtitleFile(ms.ToArray(), (Guid)model.videoid, userlogin.userid, model.subtitlefile.FileName, sitePath, hosturl);
                    }
                    if (message.MessageCode < 0)
                        return BadRequest(message);

                    FileActionDto _fileinfo = message.MessageData as FileActionDto;
                    model.subtitlefilepath = _fileinfo.filepath;
                    model.subtitlefileurl = _fileinfo.fileurl;

                    if (message.MessageCode < 0)
                        return BadRequest(message);
                }

                message = await _thisService.AddNewVideoSuntitle(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/learntotrade/deleteVideosubtitle")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteVideoSubTitle(VideoSubtitleSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.RemoveVideoSubtitle(model, userlogin, processId, clientip, hosturl);
