...
namespace NextTradeAPIs.Controllers
{
    ...
    public class WebinarController : ControllerBase
    {
        ...
        public WebinarController(AuthorizationService authorizationService,
        ...
        [HttpPost]
        [Route("/api/learntotrade/addnewwebinar")]
        [AllowAnonymous]
        public async Task<IActionResult> Insertwebinar([FromForm] WebinarDto model)
        {
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/learntotrade/deletewebinar")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteWebinar(WebinarSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [Route("/api/learntotrade/getwebinars")]
        [AllowAnonymous]
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/learntotrade/editwebinar")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateWebinar([FromForm] WebinarDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.EditWebinar(model, userlogin, processId, clientip, hosturl);
