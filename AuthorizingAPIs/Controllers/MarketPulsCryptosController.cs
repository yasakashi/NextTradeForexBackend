...
namespace NextTradeAPIs.Controllers
{
    ...
    public class MarketPulsCryptosController : ControllerBase
    {
        ...
        MarketPulsCryptoServices _service;
        CategoriesServices _baseInformationService;
        ForumsServices _forumsService;

        public MarketPulsCryptosController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       MarketPulsCryptoServices marketPulscryptoServices,
        ...
        UserServices userServices)
        {
            ...
            _service = marketPulscryptoServices;
        ...
        [HttpPost]
        [Route("/api/marketpuls/addcryptoitem")]
        [AllowAnonymous]
        public async Task<IActionResult> CreatecryptoItem(CryptoDto model)
        {
            ...
            try
            {
                ...
                message = await _service.SaveCryptoItem(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/marketpuls/editcryptoitem")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdatecryptoItem(CryptoDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _service.UpdateCryptoItem(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/marketpuls/getcryptoitems")]
        public async Task<IActionResult> GetcryptoItems(CryptoFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [HttpDelete]
        [Route("/api/marketpuls/deletecryptoitem")]
        public async Task<IActionResult> DeletecryptoItems(CryptoFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/marketpuls/crypto/gettopcategories")]
        public async Task<IActionResult> GetTopCategories(CryptoFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/marketpuls/crypto/getcategories")]
        public async Task<IActionResult> GetCategories(CryptoFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetCategory4MarketPulsCrypto(model, null, processId, clientip, hosturl, false);
        ...
        [HttpPost]
        [HttpGet]
        [Route("/api/marketpuls/crypto/getcurrencies")]
        public async Task<IActionResult> GetcryptoCurrencies(CryptoFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _baseInformationService.GetCategoryCurrency4MarketPulsCrypto(model, null, processId, clientip, hosturl, false);
