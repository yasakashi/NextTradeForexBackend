...
namespace NextTradeAPIs.Controllers
{
    ...
    public class CourseCommentController : ControllerBase
    {
        ...
        CourseCommentServices _thisService;

        public CourseCommentController(AuthorizationService authorizationService,
                                       IHttpContextAccessor httpContextAccessor,
                                       IWebHostEnvironment env,
                                       SystemLogServices systemLogServices,
                                       BlockedIPServices blockedIPServices,
                                       CategoriesServices userTypeServices,
                                       CourseCommentServices courseBuilderServices,
        ...
        [AllowAnonymous]
        public async Task<IActionResult> InsertComment([FromForm] CourseCommentDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddNewCourseComment(model, userlogin, processId, clientip, hosturl);
        ...
        [AllowAnonymous]
        public async Task<IActionResult> Deletecomment(CourseCommentSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.RemoveCourseComment(model, userlogin, processId, clientip, hosturl);
        ...
        [AllowAnonymous]
        public async Task<IActionResult> Getcomments(CourseCommentSearchDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetCourseComments(model, userlogin, processId, clientip, hosturl);
        ...
        [AllowAnonymous]
        public async Task<IActionResult> Updatecomment([FromForm] CourseCommentDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.EditCourseComment(model, userlogin, processId, clientip, hosturl);
