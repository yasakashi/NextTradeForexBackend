...
namespace NextTradeAPIs.Controllers
{
    ...
    public class CourseBuilderController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/api/coursebuilder/chnagecoursestatus")]
        [AllowAnonymous]
        public async Task<IActionResult> ChangeCourseStatus(CourseBuilderCourseFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
        ...
        [HttpPost]
        [Route("/api/coursebuilder/deletecoursemeeting")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteCourseMeeting(CourseBuilderMeetingDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.DeleteCourseMeeting(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/getcoursemeeting")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCourseMeeting(CourseBuilderMeetingFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetCourseMeetings(model, null, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/coursebuilder/editcoursemeeting")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateCourseMeeting(CourseBuilderMeetingFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.UpdateCourseMeetings(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/deletecoursevideopdfurl")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteCourseVideoPdfUrl(CourseBuildeVideoPdfUrlFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.DeleteCourseVideoPdfUrl(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/getcoursevideopdfurl")]
        [AllowAnonymous]
        public async Task<IActionResult> GetCourseVideoPdfUrl(CourseBuildeVideoPdfUrlFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.GetCourseVideoPdfUrl(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetCourses(CourseBuilderCourseFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.GetCourses(model, userlogin, processId, clientip, hosturl, false);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/updatecourse")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateCourse(CourseBuilderCourseDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.UpdateCourse(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> InsertCourseTopic(CourseBuilderTopicDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddCourseTopics(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [HttpPut]
        [Route("/api/coursebuilder/editcoursetopic")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateCourseTopics(CourseBuilderTopicDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.UpdateCourseTopic(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/deletecoursetopic")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteCourseTopic(CourseBuilderTopicDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.DeleteCourseTopics(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> InsertLesson([FromForm] CourseBuilderLessonDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.AddNewCourseLesson(model, userlogin, processId, clientip, hosturl);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/editlesson")]
        [AllowAnonymous]
        public async Task<IActionResult> UpdateLesson([FromForm] CourseBuilderLessonDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.UpdateCourseLesson(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetLessons(CourseBuilderLessonFilterDto model)
        {
            ...
            try
            {
                ...
                message = await _thisService.GetCourseLessons(model, userlogin, processId, clientip, hosturl, false);
        ...
        [HttpPost]
        [Route("/api/coursebuilder/deleteLesson")]
        [AllowAnonymous]
        public async Task<IActionResult> DeleteLesson(CourseBuilderLessonFilterDto model)
        {
            StackTrace stackTrace = new StackTrace();
            SystemMessageModel message;
            string processId = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                message = await _thisService.DeleteCourseLessons(model, userlogin, processId, clientip, hosturl);
        ...
        public async Task<IActionResult> GetImageFileURL(Guid id)
        {
            ...
            {
                CourseBuilderCourse data = message.MessageData as CourseBuilderCourse;
                string relativePath = hosturl + data.featuredImagepath.Substring(data.featuredImagepath.IndexOf("wwwroot\\")).Replace("wwwroot", "").Replace("\\", "/");
