...
public class CategoriesServices
{
    ...
    public async Task<SystemMessageModel> GetTopCategory4MarketPulsStock(StockFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetCategory4MarketPulsStock(StockFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetTopCategory4MarketPulsForexChart(ForexChartFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetCategory4MarketPulsForexChart(ForexChartFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetCategoryCurrency4MarketPulsForexChart(ForexChartFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    internal async Task<SystemMessageModel> GetTopCategory4MarketPulsstrategy(StrategyFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetCategory4MarketPulsstrategy(StrategyFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
    ...
    public async Task<SystemMessageModel> GetCategoryCurrency4MarketPulsstrategy(StrategyFilterDto model, object value, string processId, string clientip, string hosturl, bool v)
    {
        SystemMessageModel message;
        StackTrace stackTrace = new StackTrace();
        string methodpath = stackTrace.GetFrame(0).GetMethod().DeclaringType.FullName + " => " + stackTrace.GetFrame(0).GetMethod().Name;
