...
namespace Entities.Dtos
{
    public class Stock_FlexibleBlockDto
    {
        ...
        public List<StockCountriesDataDto>? countriesdatalist { get; set; }
        public List<StockFirstCountryDataDto>? firstcountrydatalist { get; set; }
        public List<StockSecondCountryDataDto>? secondcountrydatalist { get; set; }
    }
}
