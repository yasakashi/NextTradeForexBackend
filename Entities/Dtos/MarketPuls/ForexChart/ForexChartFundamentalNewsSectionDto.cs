...
{
    public class ForexChartFundamentalNewsSectionDto
    {
        public Guid? id { get; set; }
        public Guid? forexchartid { get; set; }
        public string? maintitle { get; set; }
        public string? script { get; set; }
        public List<ForexChartNewsMainContentDto>? newsmaincontentlist { get; set; }
    }
    public class ForexChartNewsMainContentDto
    {
        public Guid? id { get; set; }
        public Guid? forexchartid { get; set; }
