...
{
    public class Crypto_FundamentalandNewsSectionDto
    {
        public Guid? id { get; set; }
        public Guid? cryptoid { get; set; }
        public string? maintitle { get; set; }
        public string? script { get; set; }
        public List<Crypto_NewsMainContentDto>? newsmaincontentlist { get; set; }
    }
    public class Crypto_NewsMainContentDto
    {
        public Guid? id { get; set; }
        public Guid? cryptoid { get; set; }
